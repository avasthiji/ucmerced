...
//	}
//
//	public Map<Integer, Long> calculateCases(long initialPopulation, int numnerOfFollowupYears, float reductionRate, int reductionRateAfteryear, float percentIncreateInCasePerYear){
//		Map<Integer, Long> agePopulationMap = new HashMap<Integer, Long>();
//		long prevPopulation = 0;
//		int i = 0;
//		int iterator = 0;
